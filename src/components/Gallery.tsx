      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        >
          ...
          <p className="mx-auto mt-4 max-w-lg text-[#a0a0a0]">
            Ein Blick auf unsere Handwerkskunst. Jeder Schnitt erzählt eine Geschichte.
          </p>
        </motion.div>
          ...
          {galleryItems.map((item, i) => (
            ...
            >
              ...
              <div className="absolute inset-0 flex items-end bg-gradient-to-t from-[#0d0d0d]/90 via-[#0d0d0d]/20 to-transparent opacity-0 transition-opacity duration-500 group-hover:opacity-100">
                <div className="p-6">
                  <div className="h-[2px] w-8 bg-[#c9a84c] mb-3 transform -translate-x-4 opacity-0 transition-all duration-500 group-hover:translate-x-0 group-hover:opacity-100" />
