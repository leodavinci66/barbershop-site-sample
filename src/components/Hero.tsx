...
const headingWords = ["Dein", "Style.", "Dein", "Barber."];
...
export default function Hero() {
  return (
    <section className="relative flex min-h-screen items-center justify-center overflow-hidden bg-midnight">
      ...
      >
        <svg width="120" height="120" viewBox="0 0 24 24" fill="none" stroke="#c9a84c" strokeWidth="0.5">
      ...
      >
        <svg width="100" height="100" viewBox="0 0 24 24" fill="none" stroke="#c9a84c" strokeWidth="0.5">
      ...
      <div className="relative z-10 mx-auto max-w-5xl px-6 text-center">
        ...
        <motion.div
          ...
          className="mb-8 inline-flex items-center gap-2 border border-[#c9a84c]/20 bg-[#c9a84c]/5 px-4 py-1.5 backdrop-blur-sm"
        >
        ...
        <h1 className="font-serif text-5xl font-bold leading-[1.1] tracking-tight sm:text-7xl md:text-8xl lg:text-9xl">
          {headingWords.map((word, i) => (
            <motion.span
              ...
              className={`inline-block ${i === 1 || i === 3 ? "text-[#c9a84c]" : "text-cream"} ${
        ...
        <motion.p
          ...
          className="mx-auto mt-8 max-w-xl text-lg text-[#a0a0a0] sm:text-xl"
        >
          Erstklassige Herrenpflege im Herzen von Wien.
          <br className="hidden sm:block" />
          Traditionelle Handwerkskunst trifft modernen Style.
        </motion.p>
        ...
        >
          <a
            href="#contact"
            className="group relative inline-flex items-center gap-3 overflow-hidden bg-[#c9a84c] px-10 py-4 text-sm font-bold uppercase tracking-[0.2em] text-[#0d0d0d] transition-all duration-500 hover:shadow-[0_0_50px_rgba(201,168,76,0.4)]"
          >
          ...
          <a
            href="#services"
            className="inline-flex items-center gap-2 border border-[#2a2a2a] px-8 py-4 text-sm font-medium uppercase tracking-[0.15em] text-[#a0a0a0] transition-all duration-300 hover:border-[#c9a84c]/30 hover:text-cream"
          >
            Unsere Leistungen
          </a>
        </motion.div>
        ...
        >
          ...
          >
            <span className="text-[10px] uppercase tracking-[0.3em] text-[#a0a0a0]/50">Scroll</span>
            <div className="h-10 w-[1px] bg-gradient-to-b from-[#c9a84c]/50 to-transparent" />
          </motion.div>
        </motion.div>
      </div>
    </section>
